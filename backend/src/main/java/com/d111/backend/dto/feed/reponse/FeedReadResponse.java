...
public class FeedReadResponse {
    ...
    public static class FeedInfo {
        ...
        public FeedInfo(Long feedId, User user, String feedTitle, String feedContent, String feedThumbnail, Long originWriter, CoordiContainer coordiContainer, LocalDate feedCreatedDate, LocalDate feedUpdatedDate, List<CommentInfo> comments) {
            this.feedId = feedId;
            this.user = user;
