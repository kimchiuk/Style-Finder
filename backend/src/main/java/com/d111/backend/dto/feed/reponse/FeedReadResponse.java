...
public class FeedReadResponse {
    ...
    public static FeedReadResponse createFeedReadResponse(String message, Feed feed, MongoCoordiRepository mongoCoordiRepository) {
        ...
        FeedInfo feedInfo = new FeedInfo(feed.getId(), feed.getUserId().getId(), feed.getFeedTitle(), feed.getFeedContent(), feed.getFeedThumbnail(), feed.getOriginWriter(), coordiContainer, feed.getFeedCreatedDate(), feed.getFeedUpdatedDate());
    ...
    public static class FeedInfo {
        ...
        public FeedInfo(Long feedId, Long userId, String feedTitle, String feedContent, String feedThumbnail, Long originWriter, CoordiContainer coordiContainer, LocalDate feedCreatedDate, LocalDate feedUpdatedDate) {
            this.feedId = feedId;
            this.userId = userId;
