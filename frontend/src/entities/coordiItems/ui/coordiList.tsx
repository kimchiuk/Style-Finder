...
const CoordiList = (props: ClothesList) => {
  ...
  return (
    <div>
      <div className='font-bold text-xl text-center'>머리</div>
      <div className="flex">
      ...
      <div className='font-bold text-xl text-center'>상의</div>
      <div className="flex">
      ...
      <div className='font-bold text-xl text-center'>하의</div>
      <div className="flex">
      ...
      <div className='font-bold text-xl text-center'>신발</div>
      <div className="flex">
